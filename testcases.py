...
class TestCase(abc.ABC):
    ...
    def scenario() -> str:
        ...
        return "simple-p2p --delay=1ms --bandwidth=100Mbps --queue=1000"
...
class TestCaseLongRTT(TestCaseHandshake):
    ...
    def scenario() -> str:
        """Scenario for the ns3 simulator"""
        return "simple-p2p --delay=750ms --bandwidth=100Mbps --queue=1000"
...
class TestCaseAmplificationLimit(TestCase):
    ...
    def scenario() -> str:
        ...
        return "droplist --delay=1ms --bandwidth=100Mbps --queue=1000 --drops_to_server=2,3,4,5,6,7"
...
class TestCaseBlackhole(TestCase):
    ...
    def scenario() -> str:
        """Scenario for the ns3 simulator"""
        return "blackhole --delay=1ms --bandwidth=100Mbps --queue=1000 --on=5s --off=2s"
...
class TestCaseHandshakeLoss(TestCase):
    ...
    def scenario() -> str:
        """Scenario for the ns3 simulator"""
        return "drop-rate --delay=1ms --bandwidth=100Mbps --queue=1000 --rate_to_server=30 --rate_to_client=30 --burst_to_server=3 --burst_to_client=3"
...
class TestCaseTransferLoss(TestCase):
    ...
    def scenario() -> str:
        """Scenario for the ns3 simulator"""
        return "drop-rate --delay=1ms --bandwidth=100Mbps --queue=1000 --rate_to_server=2 --rate_to_client=2 --burst_to_server=3 --burst_to_client=3"
...
class TestCaseHandshakeCorruption(TestCaseHandshakeLoss):
    ...
    def scenario() -> str:
        """Scenario for the ns3 simulator"""
        return "corrupt-rate --delay=1ms --bandwidth=100Mbps --queue=1000 --rate_to_server=30 --rate_to_client=30 --burst_to_server=3 --burst_to_client=3"
...
class TestCaseTransferCorruption(TestCaseTransferLoss):
    ...
    def scenario() -> str:
        """Scenario for the ns3 simulator"""
        return "corrupt-rate --delay=1ms --bandwidth=100Mbps --queue=1000 --rate_to_server=2 --rate_to_client=2 --burst_to_server=3 --burst_to_client=3"
...
class TestCasePortRebinding(TestCaseTransfer):
    ...
    def scenario() -> str:
        """Scenario for the ns3 simulator"""
        return "rebind --delay=1ms --bandwidth=100Mbps --queue=1000 --first-rebind=1s --rebind-freq=5s"
